...
#define _0200_TMRD_TRDGRA0_VALUE                (0x0200U)
/* TMRD register B0 (TRDGRB0) */
#define _01F3_TMRD_TRDGRB0_VALUE                (0x01F3U)
/* TMRD register C0 (TRDGRC0) */
#define _1387_TMRD_TRDGRC0_VALUE                (0x1387U)
/* TMRD register D0 (TRDGRD0) */
#define _1386_TMRD_TRDGRD0_VALUE                (0x1386U)
/* TMRD register A1 (TRDGRA1) */
#define _0BC4_TMRD_TRDGRA1_VALUE                (0x0BC4U)
/* TMRD register B1 (TRDGRB1) */
#define _0BB7_TMRD_TRDGRB1_VALUE                (0x0BB7U)
/* TMRD register C1 (TRDGRC1) */
#define _1387_TMRD_TRDGRC1_VALUE                (0x1387U)
/* TMRD register D1 (TRDGRD1) */
#define _1386_TMRD_TRDGRD1_VALUE                (0x1386U)
